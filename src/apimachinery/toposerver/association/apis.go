...
type AssociationInterface interface {
	...
	DeleteAssociationRelatedInst(ctx context.Context, h http.Header, request *metadata.DeleteAssociationRelatedInstRequest) (resp *metadata.DeleteAssociationInstResult, err error)
